<form id="contact-form" method="post" action="">
    <div class="content-box" >
        <div class="content-display">
            <blockquote><p><strong><?php echo __('Edit contact'); ?></strong></p></blockquote>
            <?php echo $this->element('contact/form'); ?>
            <input type="hidden" name="contact_id" id="gateway_id" value="<?php echo $contact_id; ?>" />
        </div>
    </div>
    ...
    <div >
        ...
        <a href="javascript:void(0)" class="btn" id="contact-update-continue"><?php echo __('Save and continue'); ?></a>
