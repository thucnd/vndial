...
class GatewayController extends AppController {
    ...
    private function _getGatewayString() {
        return array(
            ...
            'gateways' => array('name' => __('Gateways'), 'width' => 100, 'align' => CENTER_ALIGNMENT),
            'gateway_codecs' => array('name' => __('Gateway Codecs'), 'width' => 100, 'align' => CENTER_ALIGNMENT),
            'gateway_timeouts' => array('name' => __('Gateway Timeouts'), 'width' => 100, 'align' => LEFT_ALIGNMENT),
            'gateway_retries' => array('name' => __('Gateway Retries'), 'width' => 50, 'align' => LEFT_ALIGNMENT),
            'gateway_originates' => array('name' => __('Gateway Originates'), 'width' => 100, 'align' => LEFT_ALIGNMENT),
