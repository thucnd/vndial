...
(function ($) {
    $.addFlex = function (t, p) {
            ...
            addData: function (data) { //parse data
                ...
                if (p.dataType == 'json') {
                    $.each(data.rows, function (i, row) {
                            ...
                            function () {
                                ...
                                if (typeof row.cell == 'undefined') {
                                    ...
                                    if (typeof row.cell[idx] != "undefined") {
                                        ...
                                        if(typeof p.colModel[idx] != 'undefined') {
                        ...
                        if(p.tickbox) {
                            var _tickboxTd = '<td><input class="child-tickbox" type="checkbox" name="'+row[p.idProperty]+'" value=""></td>';
                            $(tr).prepend(_tickboxTd);
                        }
                        $(tbody).append(tr);
                        tr = null;
                    });
        ...
        if (p.colModel) { //create model if any or create header anyway
            ...
            if(p.tickbox) {
                var _theadTB = '<th><input id="thead-tickbox" class="thead-tickbox" type="checkbox" name="thead-tickbox" value="thead-tickbox"></th>';
        ...
        if (p.usepager) {
            ...
            $(g.bDiv).after(g.pDiv);
            var html = ' <div class="pGroup"> <div class="pFirst pButton"><span></span></div><div class="pPrev pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">' + p.pagetext + ' <input type="text" size="4" value="1" class="input-mini"/> ' + p.outof + ' <span> 1 </span></span></div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pNext pButton"><span></span></div><div class="pLast pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
            ...
            if (p.useRp) {
                ...
                $('.pDiv2', g.pDiv).prepend("<div class='pGroup'><select name='rp'  class='input-small'>" + opt + "</select></div> <div class='btnseparator'></div>");
